...
<!-- MemberList.jsp 에서 보낸 파라미터를 받아 custno 변수에 저장, value에서 출력 -->
	...
	<section>
		...
		자바빈을 만든 후에 자바빈 객체에 dto의 각 필드값을 전달한 것
		=> 매우 비효율적 , 그래서 forward로 해결해볼 예정
		 -->
...
%>
		...
		<table>
			<tr>
				...
				<td><input type="text" id="custNo" value="${param.custno}">
					<input type="hidden" name="number" value="${param.custno}">
				</td>
			</tr>
